defmodule CharacterSheetWeb.PlayerAuth do
  use CharacterSheetWeb, :verified_routes
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_character_sheet_web_player_remember_me"
  ...
  def log_out_player(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      CharacterSheetWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_player:
      ...
      defmodule CharacterSheetWeb.PageLive do
        use CharacterSheetWeb, :live_view

        on_mount {CharacterSheetWeb.PlayerAuth, :mount_current_player}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{CharacterSheetWeb.PlayerAuth, :ensure_authenticated}] do
