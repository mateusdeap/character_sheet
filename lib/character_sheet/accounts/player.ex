defmodule CharacterSheet.Accounts.Player do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, CharacterSheet.Repo)
  ...
  """
  def valid_password?(%CharacterSheet.Accounts.Player{hashed_password: hashed_password}, password)
