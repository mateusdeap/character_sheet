defmodule CharacterSheetWeb.PlayerAuthTest do
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, CharacterSheetWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_player/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      CharacterSheetWeb.Endpoint.subscribe(live_socket_id)
